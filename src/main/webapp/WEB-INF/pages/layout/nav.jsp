                ...
                <div class="col-xs-11 text-right menu-1">
                    <ul>
                        ...
                        <li class="has-dropdown <c:if test="${index==3}">active</c:if>">
                            ...
                            <%--<ul class="dropdown">--%>
                                <%--<li><a href="http://localhost:8080/catalogue/1.html#" target="_blank">EXCEL VBA</a></li>--%>
                            <%--</ul>--%>
                        </li>
                        <%--</shiro:hasPermission>--%>
                        ...
                        <%--</shiro:hasPermission>--%>
                        <li class="<c:if test="${index==5}">active</c:if>"><a href="/zhiku/chair.tkm">线下讲座</a></li>
                        <%--<shiro:hasPermission name="zhiku:contact">--%>
                        <li class="<c:if test="${index==6}">active</c:if>"><a href="/zhiku/contact.tkm">联系我们</a></li>
                        <%--</shiro:hasPermission>--%>
                        <shiro:guest>
